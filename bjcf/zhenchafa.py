...
while (cap.isOpened()):
    ...
    if ret == True:
        ...
        if (frameNum >= 2):
            ...
            Image.fromarray(frame).convert('RGB').save('./bjcf/frame/' + str(frameNum) + '.jpg')
            Image.fromarray(currentframe).convert('RGB').save('./bjcf/currentframe/' + str(frameNum) + '.jpg')
            Image.fromarray(median).convert('RGB').save('./bjcf/median/' + str(frameNum) + '.jpg')
